...
import { FaHospitalAlt,FaAmbulance,FaEye,FaChild,FaTooth     } from "react-icons/fa";
import { MdOutlinePregnantWoman } from "react-icons/md";

// import images
import service1 from "../assets/services/gp-consult.jpg"
import service2 from "../assets/services/optician.jpg"
import service3 from "../assets/services/child care.jpg"
import service4 from "../assets/services/obster.jpg"
import service5 from "../assets/services/group1.jpg"
import service6 from "../assets/services/dental-care.jpg"
    ...
    <div className='py-20 px-5 bg-gray-50'>
        <section className='flex flex-col justify-center items-center mb-10 '>
           <h5 className='text-sm bg-blue-100 text-blue-500 uppercase w-fit font-semibold px-5 py-3'> Our Services</h5>
            <h2 className='text-3xl md:text-4xl font-bold mb-10'>Explore our main service</h2>
        </section>

        <section className='grid grid-cols-3 justify-between gap-5 md:grid-cols-2 lg:grid-cols-3'>
